...
public class zenithia_advanced_central_computing_core extends BaseHullMod {
	...
	public String getDescriptionParam(int index, HullSize hullSize) {
		...
		//if (index == 0) return "" + (int)((RANGE_MULT - 1f) * 100f);
		//if (index == 0) return "" + new Float(VISION_BONUS).intValue();
		return null;
	}
